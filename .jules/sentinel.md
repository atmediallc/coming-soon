...
## 2024-07-04 - Client and Server Length Constraints
**Vulnerability:** Missing input length limits
**Learning:** Missing payload length boundaries on forms and APIs allow excessive memory consumption leading to DoS.

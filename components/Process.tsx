...
// ⚡ Bolt Optimization: Pre-calculate complex Tailwind class strings
// and static data arrays outside the render loop to prevent unnecessary
// recalculations and garbage collection during re-renders.
                ...
                {PROCESS_STEPS_REGULAR.map((step) => (
                  <li key={step.label} className="flex items-start space-x-4 relative">
                    ...
                    <div
                      ...
                      aria-hidden="true"
                    >
                      <span className="text-[11px] font-bold text-white">{step.indexNumber}</span>
                    </div>
                    {/* Content */}
                    <div

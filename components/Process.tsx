...
// Performance optimization: Pre-calculate complex Tailwind class strings and static arrays outside the render loop
const KEY_OUTCOMES = [
...
const PRECALCULATED_PROCESS_STEPS_REGULAR = PROCESS_STEPS_REGULAR.map((step) => ({
  ...step,
  stepNumberClass: cn(
          ...
          <div className="flex-1 w-full max-w-lg">
            <div className="relative glass p-8 md:p-10 rounded-3xl border border-white/5 overflow-hidden">
              ...
              <ol className="relative flex flex-col space-y-5" aria-label="TraderAdd workflow steps">
                {PRECALCULATED_PROCESS_STEPS_REGULAR.map((step, i, arr) => (

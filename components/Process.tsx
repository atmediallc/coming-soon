...
// static arrays outside of the React render loop. Running `cn` inside
                ...
                {PROCESS_STEPS_REGULAR.map((step) => (
                  <li key={step.label} className="flex items-start space-x-4 relative">
                    ...
                    <div
                      ...
                      aria-hidden="true"
                    >
                      <span className="text-[11px] font-bold text-white">{step.index + 1}</span>
                    </div>
                    {/* Content */}
                    <div

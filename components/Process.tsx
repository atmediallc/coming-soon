...
// ⚡ Bolt: Hoisted static array outside render loop to prevent unnecessary memory allocations
const KEY_OUTCOMES = [
...
// ⚡ Bolt: Pre-calculated complex Tailwind class strings for static data outside render loop
const PRECALCULATED_STEPS = PROCESS_STEPS_REGULAR.map((step) => ({
  ...step,
  stepNumberClass: cn(
          ...
          <div className="flex-1 w-full max-w-lg">
            <div className="relative glass p-8 md:p-10 rounded-3xl border border-white/5 overflow-hidden">
              ...
              <ol className="relative flex flex-col space-y-5" aria-label="TraderAdd workflow steps">
                {PRECALCULATED_STEPS.map((step, i, arr) => (

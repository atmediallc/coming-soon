...
// of the React render loop. Running `cn` inside .map() during every render cycle
// wastes CPU cycles on static data arrays.
...
// ⚡ Bolt Optimization: Hoisted static array to prevent memory allocation on every render
const KEY_OUTCOMES = [

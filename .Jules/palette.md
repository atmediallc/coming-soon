...
## 2024-07-03 - Dark Mode Text Contrast
**Learning:** Using text opacities below 50% (like `text-white/20` or `text-white/40`) on dark backgrounds reduces readability and causes accessibility contrast failures against WCAG AA guidelines.
**Action:** Use at least `text-white/50` or `text-muted` for all secondary text to ensure sufficient contrast and readability.
